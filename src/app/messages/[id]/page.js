...
export default function Chat() {
  ...
  return (
    <>
      {loading ? (
        <div className="w-full h-full flex items-center justify-center bg-[#1D1D1D]">
          <ScaleLoader color="#00B879" className="mx-auto mt-10" />
        </div>
      ) : (
        <>
          {id ? (
                ...
                <div className="block md:hidden">
                  <Link href="/messages">
                    <div className="flex items-center gap-4 justify-center">
                      ...
                      <Image
                        src={
                          conversation.otherUser?.avatar || "/unknown-user.jpg"
                        }
                        alt="other user"
